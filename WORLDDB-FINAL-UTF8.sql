-- --------------------------------------------------------
-- Hôte:                         127.0.0.1
-- Version du serveur:           5.6.11 - MySQL Community Server (GPL)
-- Serveur OS:                   Win32
-- HeidiSQL Version:             8.3.0.4702
-- --------------------------------------------------------
...
-- Export de la structure de table worldwithfkeys. city
CREATE TABLE IF NOT EXISTS `city` (
  ...
  CONSTRAINT `FK_city_country` FOREIGN KEY (`CountryCode`) REFERENCES `country` (`Code`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4080 DEFAULT CHARSET=utf8;

-- Export de données de la table worldwithfkeys.city: ~4 177 rows (environ)
DELETE FROM `city`;
/*!40000 ALTER TABLE `city` DISABLE KEYS */;
INSERT INTO `city` (`City_Id`, `Name`, `CountryCode`, `District`, `Population`) VALUES
...
-- Export de la structure de table worldwithfkeys. country
...
-- Export de données de la table worldwithfkeys.country: ~230 rows (environ)
DELETE FROM `country`;
...
-- Export de la structure de table worldwithfkeys. countrylanguage
CREATE TABLE IF NOT EXISTS `countrylanguage` (
  `CountryLanguage_Id` int(11) NOT NULL AUTO_INCREMENT,
  `CountryCode` char(3) NOT NULL DEFAULT '',
  `Language` char(30) NOT NULL DEFAULT '',
  `IsOfficial` enum('T','F') NOT NULL DEFAULT 'F',
  `Percentage` float(4,1) NOT NULL DEFAULT '0.0',
  PRIMARY KEY (`CountryLanguage_Id`),
  KEY `FK_countrylanguage_country` (`CountryCode`),
  CONSTRAINT `FK_countrylanguage_country` FOREIGN KEY (`CountryCode`) REFERENCES `country` (`Code`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;

-- Export de données de la table worldwithfkeys.countrylanguage: ~10 rows (environ)
DELETE FROM `countrylanguage`;
/*!40000 ALTER TABLE `countrylanguage` DISABLE KEYS */;
INSERT INTO `countrylanguage` (`CountryLanguage_Id`, `CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES
	(1, 'ABW', 'Dutch', 'T', 5.3),
	(2, 'ABW', 'English', 'F', 9.5),
